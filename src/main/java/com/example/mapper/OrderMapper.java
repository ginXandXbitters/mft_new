...
public interface OrderMapper {
    ...
    void InsertOrder(String orderID,String userID,String goodID,String quantity,String buytime);
    ...
    List<Order> ShowOrder(String uid);
    ...
    List<Order> ShowDetail(String orderId);
}
